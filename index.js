const interFont = new FontFace(
  "Inter",
  "url(/assets/fonts/Inter-VariableFont_opsz,wght.ttf)",
  {
    weight: 900,
  }
);
...
interFont.load().then(drawMovingText("ONXZY"));
